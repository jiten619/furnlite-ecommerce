!function (d) {
    ...
    d(document).ready(function () {
        n(), e(), d(document).on("click", ".menu-toggle", function () {
            ...
            var e = d(this), a = e.closest(".menu-item"), t = e.closest(".furgan-menu-panel"), l = e.attr("href");
            if (d(l).length) {
                ...
                var u = a.find(".furgan-menu-item-title").attr("title"), i = "";
            ...
            if (void 0 === l || 0 == typeof l) d(".furgan-menu-panels-actions-wrap .furgan-menu-prev-panel").remove(), d(".furgan-menu-panels-actions-wrap .furgan-menu-current-panel-title").remove(); else {
...
jQuery(function (e) {
    ...
    e("body").on("init", ".furgan-tabs-wrapper, .furgan-tabs", function () {
        ...
        var a = window.location.hash, t = window.location.href, n = e(this).find(".furgan-tabs, ul.tabs").first();
        ...
        a.preventDefault();
        var t = e(this), n = t.closest(".furgan-tabs-wrapper, .furgan-tabs");
        ...
        var t = $(a.target).closest(".furgan-dropdown"), n = $(".furgan-dropdown");
        ...
        var t = $(this), n = t.data("id"), e = t.attr("href"), s = t.data("ajax"), l = t.data("section"),
            i = t.data("animate"), o = t.closest(".tab-link,.furgan-accordion").find("a.loaded").attr("href");
        1 != s || t.hasClass("loaded") ? (t.parent().addClass("active").siblings().removeClass("active"), $(e).addClass("active").siblings().removeClass("active"), t.closest(".panel-default").addClass("active").siblings().removeClass("active"), t.closest(".furgan-accordion").find(e).slideDown(400), t.closest(".furgan-accordion").find(".panel-collapse").not(e).slideUp(400), furgan_animation_tabs($(e), i)) : ($(e).closest(".tab-container,.furgan-accordion").addClass("loading"), t.parent().addClass("active").siblings().removeClass("active"), $.ajax({
            ...
            data: {action: "furgan_ajax_tabs", security: furgan_ajax_frontend.security, id: n, section_id: l},
            success: function (a) {
...
jQuery(function (u) {
    ...
    window.addEventListener("load", function (t) {
        ...
        s = u(".furgan-mapper"), e = u(".furgan-pin"), a = s.data("width"), i = s.data("height"), e.each(function () {
            ...
            t.on("click", function () {
                var t = u(this), s = t.siblings(".furgan-popup");
                if (s.length) {
                ...
                var t = u(this).closest(".furgan-pin"), s = t.find(".furgan-popup");
